...
from model_crnn_step4_date import models, params, dataset, utils


from torch.autograd import Variable

weight = '/home/huyvd/Documents/works/pytorch_tutorial/tap_code/indo_card_code/demo_main/weight/crnn_ngay_cap.pth'
input_size = (params.imgW, params.imgH)

nclass = len(params.alphabet) + 1


class date_PredictCRNN:
    def __init__(self):
