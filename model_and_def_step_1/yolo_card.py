...
from model_and_def_step_1.yolo3.model import yolo_eval, yolo_body, tiny_yolo_body
from model_and_def_step_1.yolo3.utils import letterbox_image
import os


class YOLO_box_card(object):
    _defaults = {
        "model_path": 'weight/yolo_30000.h5',
        "anchors_path": 'model_and_def_step_1/model_data/yolo_anchors.txt',
        "classes_path": 'model_and_def_step_1/model_data/coco_classes.txt',
        "score": 0.3,
        "iou": 0.45,
    ...
    def predict_card(self, img):
        dict_main = self.detect_image(img)
        list_predict = []

        if dict_main:
            for dict_bb in dict_main.get('card'):
                list_predict.append(dict_bb)
