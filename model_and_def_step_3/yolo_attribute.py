...
from model_and_def_step_3.yolo3_attribute.model import yolo_eval, yolo_body, tiny_yolo_body
from model_and_def_step_3.yolo3_attribute.utils import letterbox_image
import os

from PIL import Image


class YOLO_atb(object):
    _defaults = {
        "model_path": 'weight/yolov3_30000_atb.h5',
        "anchors_path": 'model_and_def_step_3/model_data/yolo_anchors.txt',
        "classes_path": 'model_and_def_step_3/model_data/coco_classes.txt',
        "score": 0.3,
        "iou": 0.2,
